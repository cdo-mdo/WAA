a) status of the lab, I finished the lab01
- I use spring-boot 3.5.6 and IntelliJ. First I adapt the code to spring-boot 3.5.6 to make it works
  and then I update the code by requirement of tha lab-01
